...
namespace Books_Stock_Market.Data.Migrations
{
    ...
    [Migration("20221228122057_Responds bool adding")]
    partial class Respondsbooladding
    {
            ...
            modelBuilder.Entity("Books_Stock_Market.Data.Entities.SubjectEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2022, 12, 28, 12, 20, 57, 371, DateTimeKind.Utc).AddTicks(3630),
                            SubjectName = "J. Angielski",
                            UpdatedAt = new DateTime(2022, 12, 28, 12, 20, 57, 371, DateTimeKind.Utc).AddTicks(3631)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2022, 12, 28, 12, 20, 57, 371, DateTimeKind.Utc).AddTicks(3643),
                            SubjectName = "J. Polski",
                            UpdatedAt = new DateTime(2022, 12, 28, 12, 20, 57, 371, DateTimeKind.Utc).AddTicks(3643)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2022, 12, 28, 12, 20, 57, 371, DateTimeKind.Utc).AddTicks(3648),
                            SubjectName = "J. Niemiecki",
                            UpdatedAt = new DateTime(2022, 12, 28, 12, 20, 57, 371, DateTimeKind.Utc).AddTicks(3649)
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2022, 12, 28, 12, 20, 57, 371, DateTimeKind.Utc).AddTicks(3653),
                            SubjectName = "Matematyka",
                            UpdatedAt = new DateTime(2022, 12, 28, 12, 20, 57, 371, DateTimeKind.Utc).AddTicks(3653)
                        });
                });
