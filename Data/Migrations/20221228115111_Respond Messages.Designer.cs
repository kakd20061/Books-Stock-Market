...
namespace Books_Stock_Market.Data.Migrations
{
    ...
    [Migration("20221228115111_Respond Messages")]
    partial class RespondMessages
    {
            ...
            modelBuilder.Entity("Books_Stock_Market.Data.Entities.SubjectEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2022, 12, 28, 11, 51, 11, 505, DateTimeKind.Utc).AddTicks(1325),
                            SubjectName = "J. Angielski",
                            UpdatedAt = new DateTime(2022, 12, 28, 11, 51, 11, 505, DateTimeKind.Utc).AddTicks(1327)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2022, 12, 28, 11, 51, 11, 505, DateTimeKind.Utc).AddTicks(1340),
                            SubjectName = "J. Polski",
                            UpdatedAt = new DateTime(2022, 12, 28, 11, 51, 11, 505, DateTimeKind.Utc).AddTicks(1340)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2022, 12, 28, 11, 51, 11, 505, DateTimeKind.Utc).AddTicks(1346),
                            SubjectName = "J. Niemiecki",
                            UpdatedAt = new DateTime(2022, 12, 28, 11, 51, 11, 505, DateTimeKind.Utc).AddTicks(1346)
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2022, 12, 28, 11, 51, 11, 505, DateTimeKind.Utc).AddTicks(1351),
                            SubjectName = "Matematyka",
                            UpdatedAt = new DateTime(2022, 12, 28, 11, 51, 11, 505, DateTimeKind.Utc).AddTicks(1351)
                        });
                });
