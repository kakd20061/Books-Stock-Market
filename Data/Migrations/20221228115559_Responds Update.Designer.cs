...
namespace Books_Stock_Market.Data.Migrations
{
    ...
    [Migration("20221228115559_Responds Update")]
    partial class RespondsUpdate
    {
            ...
            modelBuilder.Entity("Books_Stock_Market.Data.Entities.SubjectEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2022, 12, 28, 11, 55, 59, 187, DateTimeKind.Utc).AddTicks(4100),
                            SubjectName = "J. Angielski",
                            UpdatedAt = new DateTime(2022, 12, 28, 11, 55, 59, 187, DateTimeKind.Utc).AddTicks(4103)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2022, 12, 28, 11, 55, 59, 187, DateTimeKind.Utc).AddTicks(4145),
                            SubjectName = "J. Polski",
                            UpdatedAt = new DateTime(2022, 12, 28, 11, 55, 59, 187, DateTimeKind.Utc).AddTicks(4145)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2022, 12, 28, 11, 55, 59, 187, DateTimeKind.Utc).AddTicks(4151),
                            SubjectName = "J. Niemiecki",
                            UpdatedAt = new DateTime(2022, 12, 28, 11, 55, 59, 187, DateTimeKind.Utc).AddTicks(4152)
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2022, 12, 28, 11, 55, 59, 187, DateTimeKind.Utc).AddTicks(4157),
                            SubjectName = "Matematyka",
                            UpdatedAt = new DateTime(2022, 12, 28, 11, 55, 59, 187, DateTimeKind.Utc).AddTicks(4157)
                        });
                });
