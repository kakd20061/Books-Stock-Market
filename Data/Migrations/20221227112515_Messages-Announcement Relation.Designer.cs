...
namespace Books_Stock_Market.Data.Migrations
{
    ...
    [Migration("20221227112515_Messages-Announcement Relation")]
    partial class MessagesAnnouncementRelation
    {
            ...
            modelBuilder.Entity("Books_Stock_Market.Data.Entities.SubjectEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2022, 12, 27, 11, 25, 15, 72, DateTimeKind.Utc).AddTicks(9603),
                            SubjectName = "J. Angielski",
                            UpdatedAt = new DateTime(2022, 12, 27, 11, 25, 15, 72, DateTimeKind.Utc).AddTicks(9604)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2022, 12, 27, 11, 25, 15, 72, DateTimeKind.Utc).AddTicks(9617),
                            SubjectName = "J. Polski",
                            UpdatedAt = new DateTime(2022, 12, 27, 11, 25, 15, 72, DateTimeKind.Utc).AddTicks(9617)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2022, 12, 27, 11, 25, 15, 72, DateTimeKind.Utc).AddTicks(9622),
                            SubjectName = "J. Niemiecki",
                            UpdatedAt = new DateTime(2022, 12, 27, 11, 25, 15, 72, DateTimeKind.Utc).AddTicks(9622)
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2022, 12, 27, 11, 25, 15, 72, DateTimeKind.Utc).AddTicks(9627),
                            SubjectName = "Matematyka",
                            UpdatedAt = new DateTime(2022, 12, 27, 11, 25, 15, 72, DateTimeKind.Utc).AddTicks(9627)
                        });
                });
