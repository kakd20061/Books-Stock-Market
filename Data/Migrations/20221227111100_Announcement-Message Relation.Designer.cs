...
namespace Books_Stock_Market.Data.Migrations
{
    ...
    [Migration("20221227111100_Announcement-Message Relation")]
    partial class AnnouncementMessageRelation
    {
            ...
            modelBuilder.Entity("Books_Stock_Market.Data.Entities.SubjectEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2022, 12, 27, 11, 10, 59, 957, DateTimeKind.Utc).AddTicks(9477),
                            SubjectName = "J. Angielski",
                            UpdatedAt = new DateTime(2022, 12, 27, 11, 10, 59, 957, DateTimeKind.Utc).AddTicks(9479)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2022, 12, 27, 11, 10, 59, 957, DateTimeKind.Utc).AddTicks(9493),
                            SubjectName = "J. Polski",
                            UpdatedAt = new DateTime(2022, 12, 27, 11, 10, 59, 957, DateTimeKind.Utc).AddTicks(9493)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2022, 12, 27, 11, 10, 59, 957, DateTimeKind.Utc).AddTicks(9498),
                            SubjectName = "J. Niemiecki",
                            UpdatedAt = new DateTime(2022, 12, 27, 11, 10, 59, 957, DateTimeKind.Utc).AddTicks(9499)
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2022, 12, 27, 11, 10, 59, 957, DateTimeKind.Utc).AddTicks(9503),
                            SubjectName = "Matematyka",
                            UpdatedAt = new DateTime(2022, 12, 27, 11, 10, 59, 957, DateTimeKind.Utc).AddTicks(9503)
                        });
                });
