...
namespace Books_Stock_Market.Data.Migrations
{
    ...
    [Migration("20221227111612_Prepare for message-pageUser relation")]
    partial class PrepareformessagepageUserrelation
    {
            ...
            modelBuilder.Entity("Books_Stock_Market.Data.Entities.SubjectEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2022, 12, 27, 11, 16, 12, 413, DateTimeKind.Utc).AddTicks(7694),
                            SubjectName = "J. Angielski",
                            UpdatedAt = new DateTime(2022, 12, 27, 11, 16, 12, 413, DateTimeKind.Utc).AddTicks(7695)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2022, 12, 27, 11, 16, 12, 413, DateTimeKind.Utc).AddTicks(7709),
                            SubjectName = "J. Polski",
                            UpdatedAt = new DateTime(2022, 12, 27, 11, 16, 12, 413, DateTimeKind.Utc).AddTicks(7709)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2022, 12, 27, 11, 16, 12, 413, DateTimeKind.Utc).AddTicks(7715),
                            SubjectName = "J. Niemiecki",
                            UpdatedAt = new DateTime(2022, 12, 27, 11, 16, 12, 413, DateTimeKind.Utc).AddTicks(7715)
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2022, 12, 27, 11, 16, 12, 413, DateTimeKind.Utc).AddTicks(7721),
                            SubjectName = "Matematyka",
                            UpdatedAt = new DateTime(2022, 12, 27, 11, 16, 12, 413, DateTimeKind.Utc).AddTicks(7721)
                        });
                });
