...
namespace Books_Stock_Market.Data.Migrations
{
    ...
    [Migration("20221229114228_FirstAdmin Seed")]
    partial class FirstAdminSeed
    {
            ...
            modelBuilder.Entity("Books_Stock_Market.Data.Entities.AdministrationEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2022, 12, 29, 11, 42, 28, 227, DateTimeKind.Utc).AddTicks(4129),
                            Email = "gizard.biznes123@vp.pl",
                            UpdatedAt = new DateTime(2022, 12, 29, 11, 42, 28, 227, DateTimeKind.Utc).AddTicks(4130)
                        });
                });
            ...
            modelBuilder.Entity("Books_Stock_Market.Data.Entities.SubjectEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2022, 12, 29, 11, 42, 28, 227, DateTimeKind.Utc).AddTicks(4077),
                            SubjectName = "J. Angielski",
                            UpdatedAt = new DateTime(2022, 12, 29, 11, 42, 28, 227, DateTimeKind.Utc).AddTicks(4081)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2022, 12, 29, 11, 42, 28, 227, DateTimeKind.Utc).AddTicks(4105),
                            SubjectName = "J. Polski",
                            UpdatedAt = new DateTime(2022, 12, 29, 11, 42, 28, 227, DateTimeKind.Utc).AddTicks(4106)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2022, 12, 29, 11, 42, 28, 227, DateTimeKind.Utc).AddTicks(4111),
                            SubjectName = "J. Niemiecki",
                            UpdatedAt = new DateTime(2022, 12, 29, 11, 42, 28, 227, DateTimeKind.Utc).AddTicks(4111)
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2022, 12, 29, 11, 42, 28, 227, DateTimeKind.Utc).AddTicks(4116),
                            SubjectName = "Matematyka",
                            UpdatedAt = new DateTime(2022, 12, 29, 11, 42, 28, 227, DateTimeKind.Utc).AddTicks(4116)
                        });
                });
