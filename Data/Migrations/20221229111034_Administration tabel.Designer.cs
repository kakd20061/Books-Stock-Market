...
namespace Books_Stock_Market.Data.Migrations
{
    ...
    [Migration("20221229111034_Administration tabel")]
    partial class Administrationtabel
    {
            ...
            modelBuilder.Entity("Books_Stock_Market.Data.Entities.SubjectEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2022, 12, 29, 11, 10, 34, 74, DateTimeKind.Utc).AddTicks(7284),
                            SubjectName = "J. Angielski",
                            UpdatedAt = new DateTime(2022, 12, 29, 11, 10, 34, 74, DateTimeKind.Utc).AddTicks(7286)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2022, 12, 29, 11, 10, 34, 74, DateTimeKind.Utc).AddTicks(7300),
                            SubjectName = "J. Polski",
                            UpdatedAt = new DateTime(2022, 12, 29, 11, 10, 34, 74, DateTimeKind.Utc).AddTicks(7301)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2022, 12, 29, 11, 10, 34, 74, DateTimeKind.Utc).AddTicks(7305),
                            SubjectName = "J. Niemiecki",
                            UpdatedAt = new DateTime(2022, 12, 29, 11, 10, 34, 74, DateTimeKind.Utc).AddTicks(7306)
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2022, 12, 29, 11, 10, 34, 74, DateTimeKind.Utc).AddTicks(7310),
                            SubjectName = "Matematyka",
                            UpdatedAt = new DateTime(2022, 12, 29, 11, 10, 34, 74, DateTimeKind.Utc).AddTicks(7310)
                        });
                });
